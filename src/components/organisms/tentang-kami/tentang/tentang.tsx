    ...
    <section className="relative w-full pt-20 pb-0">
      <div className="relative z-20 flex w-full justify-center">
        <motion.div
          ...
          className="translate-y-1/2 -rotate-2 transform px-6 py-3 text-lg font-bold text-white md:px-10 md:text-3xl"
        >
      ...
      <div className="relative z-10 rounded-t-xl bg-primary px-6 pt-24 pb-16 text-white md:rounded-t-4xl md:px-12 lg:px-[150px]">
        <div className="p flex justify-center gap-12 bg-secondary md:gap-16 lg:flex-row lg:gap-24">
          <div className="relative h-[300px] w-full rounded-sm bg-accent-orange px-0 md:rounded-2xl lg:h-[400px]">
            <Image src={ABOUT_DATA.image} alt="Ilustrasi Food Waste" fill className="rounded-2xl" />
          </div>
