...
export const CONTACT_INFO = [
  {
    href: 'mailto:hello@meal-up.my.id',
    label: 'Email',
    icon: EnvelopeIcon,
    text: 'hello@meal-up.my.id'
  },
  {
...
export const SOCIAL_LINKS = [
  { href: 'https://instagram.com/meal-up.my.id', label: 'Instagram', icon: InstagramLogoIcon },
  { href: 'https://wa.me/6285128025700', label: 'WhatsApp', icon: WhatsappLogoIcon },
