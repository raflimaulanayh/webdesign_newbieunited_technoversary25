...
Meal Up adalah platform _marketplace_ inovatif yang dirancang untuk **Lomba Web Design Technoversary 2025**. Proyek ini bertujuan mengatasi masalah _Food Waste_ dan _Food Insecurity_ dengan menghubungkan surplus makanan dari industri kuliner ke konsumen luas, mendukung pencapaian **SDG 2 (Zero Hunger)** dan **SDG 12 (Responsible Consumption)** melalui teknologi Progressive Web App (PWA).
